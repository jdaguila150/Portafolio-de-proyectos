...
private JButton altaB, consultaB, salirB, eliminarB; 
...
setSize(800, 650); // Tamaño de la ventana (ancho, alto)
...
eliminarB.setBounds (400, 350, 120, 20);
...
salirB.setBounds(550, 350, 120, 20);
salirB.setFont(new Font("TimesRoman", Font.BOLD, 18));
add(salirB);
salirB.addActionListener(this);
}
// Método implementado de la interfaz ActionListener que ejecuta las instrucciones dependiendo al botón
//accionado.
@Override
...
razaT.setText("");
    ...
    for (int i = 0; i < tamanoLista; i++) {
        ...
        if(sonIguales){
            ...
            LMascota.remove(i);
            borrar = true;
            JOptionPane.showMessageDialog(null, "SE HA BORRADO LA MASCOTA");
            break;}
            else
                JOptionPane.showMessageDialog(null, "NO SE BORRO LA MASCOTA");
        }
    }
    nombreT.setText("");
    razaT.setText("");
