...
public class GuiSignInUser extends JFrame implements ActionListener {
    

    private JButton IniciaS, RegistraU, Regresar;
    private JLabel TextPg;
    
    public GuiSignInUser(){
    ...
    public void iniciarComponentes(){
        ...
        TextPg = new JLabel("BIENVENIDO A LA BIBLIOTECA DIGITAL DEL ALUMNO");
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        if (evento.getSource().equals(IniciaS) ){
            dispose();
            IniciarSesion ingresara = new IniciarSesion();
        }
